...
var currentLevel = 1;
var levelText = document.querySelector('.level-text');
var TextMap2 = [
  'W W W W W W W W W W W W W W W W W W W W W W W W W W W',
  'W       W                                           W',
  'W   E   W   E   W W W       E   E        E          W',
  'W   E   W         W                   E             W',
  'W   E   W       W W W W W W W W W W             W W W',
  'W       W            E              E   E           W',
  'W     E                                             W',
  'W         E E                   E                   W',
  'W                                            E      W',
  ...
  function checkLevelComplete() {
    var allEnemiesDead = enemies.every(enemy => enemy.dead);
    if (allEnemiesDead && currentLevel === 1) {
  ...
  function startLevel2() {
    ...
    setTimeout(() => {
      ...
      player.x = playerPosition.x * blockSize;
      player.y = playerPosition.y * blockSize;
      player.health = 100;
      player.dead = false;
  ...
  function drawMiniMap() {
    ...
    const cellSize = miniMapSize / TextMap[0].length; 
    ...
    for (let y = 0; y < TextMap.length; y++) {
        for (let x = 0; x < TextMap[y].length; x += 2) {
            const char = TextMap[y][x];
            const realX = x / 2;

            
            const mapX = miniMapX + realX * cellSize;
            const mapY = miniMapY + y * cellSize;
            ...
            if (char === 'W') {
                ...
                context.beginPath();
                context.arc(mapX + cellSize / 2, mapY + cellSize / 2, cellSize / 4, 0, 2 * Math.PI);
  ...
  var Bullet = function (i) {
    ...
    this.update = function () {
      this.x += this.vectorX * 35;
      this.y += this.vectorY * 35;
